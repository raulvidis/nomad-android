...
class LocationRepository(
    ...
    suspend fun beginRoute(): Result<String> {
        return try {
            ...
            Result.error("Failed to begin route", e)
        }
    }

    suspend fun endRoute(): Result<Unit> {
        return Result.runCatching {
            val routeId = trackerService.activeRouteId ?: return@runCatching
            val location = trackerService.currentLocation.value
